...
BTN_LOCK_ALERT = environ.get("BTN_LOCK_ALERT", "⚠️ ʜᴇʏ {query}! ᴛʜᴀᴛ's ɴᴏᴛ ғᴏʀ ʏᴏᴜ. ᴘʟᴇᴀsᴇ ʀᴇǫᴜᴇsᴛ ʏᴏᴜʀ ᴏᴡɴ")
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', 'ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴜsᴇ ᴛʜɪs ʙᴏᴛ!')
